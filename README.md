...
Discrete dynamical systems on natural numbers induced by transformations based on prime factorization.
...
> Do numerical structures belong to numbers themselves, or do they emerge from the transformations applied to them?

The project studies transformations on natural numbers based on prime factorization, then observes the trajectories, attractors, and attraction basins generated by iteration.

This is an experimental mathematical repository.

It does not claim a complete theory.  
It provides a reproducible starting point.
...
From this factorization we can define transformations.

A transformation is then iterated:

n → T(n) → T(T(n)) → ...

The resulting trajectory may reach:
...
An attractor is a value or cycle reached by iteration.
...
This suggests that 5 is not merely a small prime.

It acts as a dominant terminal attractor under this specific arithmetic dynamics.
...
Comparing the two transformations shows how much each attractor gains from multiplicity.
...
The project also tests variants.
